...
def main():
    ...
    example = get_example_by_name('emsoft_c7')
    ...
    opts = {
        ...
        "MULTIPLICATOR_NET": [5, 5, 5, 5, 1],  # The number of nodes in each layer of the multiplier network;
        # if set to empty, the multiplier is a trainable constant.
        "MULTIPLICATOR_ACT": ['LINEAR', 'LINEAR', 'LINEAR', 'LINEAR'],
