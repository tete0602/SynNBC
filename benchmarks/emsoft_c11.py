...
def main():
    ...
    opts = {
        ...
        "LEARNING_RATE": 0.05,
        "MARGIN": 5,
        "LOSS_WEIGHT": (100.0, 1000.0, 1.0),  # They are the weights of init loss, unsafe loss, and diffB loss.
        ...
        "DEG": [2, 0, 0, 0],  # Respectively represent the times of init, unsafe, diffB,
