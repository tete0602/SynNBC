...
def main():
    activations = ['SKIP']  # Whether to use multiplier.
    hidden_neurons = [5] * len(activations)
    example = get_example_by_name('emsoft_c8')
    ...
    opts = {
        ...
        "MULTIPLICATOR_NET": [1],  # The number of nodes in each layer of the multiplier network;
